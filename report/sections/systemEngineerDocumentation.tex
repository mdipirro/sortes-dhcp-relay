...
On UNIX-based systems, the \textit{Internet Systems Consortium DHCP Server} (\texttt{dhcpd}) can be used as a daemon which provides this service; a sample configuration using the addresses specified in the project is shown in the following code box.\\
